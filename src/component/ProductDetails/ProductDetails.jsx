...
const productExist=cart.find((ele)=>ele.id===item.id)
if(productExist){
...
alert('product is just added to cart')
navigate('/cart')
}
      ...
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 text-left">
          ...
          <div className="flex">
            ...
            <button onClick={()=>handleCart(product)}  className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Add to Cart</button>
